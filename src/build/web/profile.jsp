...
String connectionUrl = "jdbc:mysql://10.106.88.26:3306/";
...
<section>
  <nav>
      ...
      <a href="mycomplaints.jsp"  id ="sidbutton" class="badge1" data-badge=<%=resultSet1.getString("count(*)")%>><i class="fa fa fa-clipboard" style="font-size: 20px;margin-right: 10px;"></i>My Complaints</a>
